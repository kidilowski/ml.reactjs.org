...
Javascript ഉപയോഗിച്ചു വേഗതയുള്ള വലിയ വെബ് അപ്പ്ലിക്കേഷൻസ് ഉണ്ടാകുവാനുള്ള ഒരു മികച്ച വഴി ആണ് React. ഫേസ്ബുക്കിലും ഇൻസ്റ്റാഗ്രാമിലും ഇത് ഞങ്ങൾക്ക് വളരെ നന്നായി സ്കെയിൽ ചെയ്തിട്ടുണ്ട്. 
...
## ഒരു മാതൃകാനിർമ്മിതിയിൽ നിന്നും തുടങ്ങാം {#start-with-a-mock}

ഞങ്ങളുടെ  ഡിസൈനർ വഴി ഒരു JSON API-യും, മാതൃകാനിർമ്മിതിയും ഉള്ളതായി വിചാരിക്കുക. താഴെ കൊടുത്തേകുന്നത് പോലെ ഇരിക്കും :

![Mockup](../images/blog/thinking-in-react-mock.png)

JSON API-യിൽ നിന്നും തിരിച്ചുവരുന്ന ഡാറ്റ താഴെ കൊടുത്തേകുന്നത് പോലെ ഇരിക്കും:
